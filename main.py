...
def register_public_api_blueprint():
    app.register_blueprint(create_public_api_blueprint({
        "get_db": get_db,
        "client_ip": client_ip,
        "apply_rate_limit": apply_rate_limit,
        "apply_daily_ip_limit": apply_daily_ip_limit,
        "default_organisation_id": default_organisation_id,
        "save_lead_payload": save_lead_payload,
        "add_lead_note": add_lead_note,
        "create_follow_up_task": create_follow_up_task,
        "write_audit_log": write_audit_log,
        "truthy": truthy,
        "chatbot_max_turns": CHATBOT_MAX_TURNS,
        "chatbot_daily_ip_limit": CHATBOT_DAILY_IP_LIMIT,
        "lead_daily_ip_limit": LEAD_DAILY_IP_LIMIT,
    }))


register_public_api_blueprint()
